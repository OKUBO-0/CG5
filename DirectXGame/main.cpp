...
int WINAPI WinMain(_In_ HINSTANCE, _In_opt_ HINSTANCE, _In_ LPSTR, _In_ int) {
	...
	ID3DBlob* vsBlob = nullptr;    //頂点シェーダオプジェクト
	ID3DBlob* psBlob = nullptr;    // ビクセルシェーダオブジェクト
	ID3DBlob* errorBlob = nullptr; //エラーオプジェクト
	// 頂点シェーダーの読み込みとコンパイル
	...
	vertexData[1] = { 0.0f,  0.5f, 0.0f, 1.0f}; // 右
	vertexData[2] = { 0.5f, -0.5f, 0.0f, 1.0f}; // 下
	// 頂点リソースのマップを解除する
